    ...
    init: function(element){
        ...
        new jQuery.Delegator(
			...
			function(event) {
				...
				if (this == event.relatedTarget || ($(this).compare(event.relatedTarget) & 16 )  ) return true;
				callback(this, event);
			});
    }
});
...
(function(){
    ...
    Hover.prototype = {
        ...
        mouseover : function(el, ev){
            ...
            var related_target = ev.relatedTarget;
    		if(related_target && (el[0] == related_target || el.compare(related_target)&16))
    			return true;
    		//}
        ...
        mouseout : function(el, ev){
            var related_target = ev.relatedTarget;
            if(related_target && (el[0] == related_target || el.compare(related_target)&16)) return true;
